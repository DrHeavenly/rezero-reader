...
Subaru: [OK. I’ve understood the terrain and its peculiarities. Next, let’s look for a weakness. Since you volunteered to be a guide, naturally there’s a way out, right? A loophole.]
...
Subaru: [Keep going! Hang in there, Gian[1]! We can only rely on your horsepower!]
...
Subaru: [It’s an application of a mini four-wheel drive. Reducing its weight to make it light would be fatal, so I couldn’t do that, but I did what I could. Alright, go, Gungnir[2]―― Penetrate!]
...
[1] Name is a Doraemon reference to the character with that nickname (ジャイアン).

[2] In Norse mythology, Gungnir is the spear owned by the king of Norse Gods, Odin. For more information, see here.

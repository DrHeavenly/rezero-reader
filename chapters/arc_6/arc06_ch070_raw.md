...
Because, in these loops, Natsuki Subaru wasーー,
...
Though he had possessed no confirmation before that question, she had a track record of having changed into the form of the titanic scorpion and murdering Subaru, Echidna and Beatrice. Otherwise, it was highly possible that she’d had a hand in that after turning into the titanic scorpion, in the tragedies that had come to pass in the loops in which Subaru had been unable to find a single person alive.
...
Of course, just because the distance between them was only the breadth of a single arm, just because he had shortened the distance between them to that of only a single arm, the difference in fighting power between him and her was not so small that it would change anything.
...
If these loops, these actions could be excused, he intended to surely do this.
